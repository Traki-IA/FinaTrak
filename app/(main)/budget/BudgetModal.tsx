...
function ModeButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-[10px] text-xs font-medium transition-all border ${
        active
        ...
        <Dialog.Content className="fixed z-50 bg-[var(--bg2)] border-[var(--border)] shadow-2xl focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out inset-x-0 bottom-0 border-t rounded-t-2xl px-5 pt-4 pb-8 max-h-[92dvh] overflow-y-auto data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-md sm:border sm:rounded-2xl sm:pb-5 sm:max-h-[90dvh] sm:data-[state=closed]:fade-out-0 sm:data-[state=open]:fade-in-0 sm:data-[state=closed]:zoom-out-95 sm:data-[state=open]:zoom-in-95">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="flex gap-2 h-[42px]">
                  {(["mensuel", "annuel"] as const).map((f) => (
                    <button
                      ...
                      className={`flex-1 rounded-[10px] text-sm font-medium transition-all border ${
                        form.frequence === f
                          ? "bg-[var(--orange)]/15 border-[var(--orange)]/40 text-[var(--orange)]"
                          : "bg-[var(--bg3)] border-[var(--border)] text-[var(--text3)] hover:text-[var(--text)]/70"
                      }`}
            ...
            <div className="space-y-3 pt-1">
              <div className="flex items-center gap-2">
                <Target size={14} className="text-[var(--text3)]" />
                <label className="text-sm text-[var(--text2)] font-medium">
              ...
              <AnimatePresence>
                {objectifMode === "existing" && (
                  ...
                  >
                    ...
                    {objectifs.length === 0 && (
                      <p className="text-[var(--text3)] text-xs mt-1.5">
                ...
                {objectifMode === "new" && !isEditMode && (
                  <motion.div
                    ...
                    className="overflow-hidden"
                  >
                    <div className="bg-[var(--bg)] border border-[var(--orange)]/20 rounded-[10px] p-4 space-y-3">
                      <p className="text-xs text-[var(--orange)]/80 font-medium">
                        Un nouvel objectif sera créé et lié à cette charge
                      </p>

                      <div className="space-y-1">
                        <label className="text-xs text-[var(--text3)] font-medium">
                          Nom de l&apos;objectif
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <select
                            ...
                            style={{ colorScheme: "dark" }}
                          >
                            <option value="ponctuel" className="bg-[var(--bg2)]">
                              Ponctuel
                            </option>
                            <option value="mensuel" className="bg-[var(--bg2)]">
                              Mensuel
                            </option>
                            <option value="annuel" className="bg-[var(--bg2)]">
                              Annuel
                            </option>
                          </select>
                        </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              {isEditMode && onDelete && budgetItem && (
                <button
                  ...
                  className="px-4 py-2.5 rounded-[10px] text-sm font-medium border border-red-500/30 bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-all"
                >
                  Supprimer
                </button>
              )}
