          ...
          <div className="mt-4 -mx-1" style={{ position: "relative" }}>
            ...
            {showPicker && (
              ...
              >
                ...
                {/* Calendrier DayPicker — styles Pulse Flat via picker.css (.pulse-picker) */}
                <div className="pulse-picker" style={{ "--rdp-accent-color": "#f97316", "--rdp-background-color": "rgba(249,115,22,0.15)" } as React.CSSProperties}>
                  <DayPicker
                    mode="range"
                    selected={range}
