...
function Parametres({
  ...
  return (
    <Shell>
      ...
      {/* Compte section — flat */}
      <div className="border-b border-[var(--bg2)] pb-4 mb-4">
        <p className="text-[11px] text-[var(--text3)] uppercase tracking-[0.14em] font-semibold mb-3">Compte</p>
        <div className="flex items-center gap-2.5">
          <div className="w-2 h-2 rounded-full bg-orange-500 shrink-0" />
          <div>
            <p className="text-[14px] font-[600] text-white leading-none">{userDisplayName}</p>
            <span className="text-[12px] text-[var(--text2)] mt-0.5 block">{userEmail}</span>
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-[var(--bg2)] pb-4 mb-4">
        ...
        <p className="text-[12px] text-[var(--text2)] mb-3">
      ...
      <div>
        ...
        <div className="border-b border-[var(--bg2)] pb-4">
          <p className="text-[14px] font-[600] text-white mb-0.5">Supprimer mon compte</p>
          <p className="text-[12px] text-[var(--text2)] mb-3 leading-relaxed">
